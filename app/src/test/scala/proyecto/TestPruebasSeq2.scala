...
class TestPruebasSeq2 extends AnyFunSuite {
  ...
  val itsCurso15 = itoObj.itinerariosTiempo(vuelosA1, aeropuertos)
  val itsCurso40 = itoObj.itinerariosTiempo(vuelosB1, aeropuertos)
  val itsCurso100 = itoObj.itinerariosTiempo(vuelosC1, aeropuertos)
